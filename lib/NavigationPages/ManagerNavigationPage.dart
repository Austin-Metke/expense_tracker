import 'package:expense_tracker/ExpensePages/ExpensesOverviewPage.dart';
import 'package:expense_tracker/ExpensePages/MyExpensesPage.dart';
...
class _ManagerNavigationPageState extends State<ManagerNavigationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IndexedStack(index: _selectedIndex, children: _managerPages),
    );
  }
}
